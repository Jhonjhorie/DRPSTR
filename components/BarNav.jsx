...
import NotifMob from './notifMob.android';  // Make sure NotifMob is properly set up
...
const SideBarNav = ({ innerSidebar, activeName }) => {
  ...
  if (isMobile) {
    return <NotifMob modalVisible={modalVisible} setModal={setModal} />;  // Pass modal state to NotifMob
  }
  ...
  // Default rendering for non-mobile
  return (
            ...
            <View className="space-y-4">
              ...
              <TouchableOpacity>
                <View className="flex-row items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-slate-200">
                  ...
                  />
                  <View className="ml-4">
                    <Text className="text-lg font-semibold">Buy 1 Get 2</Text>
